...
function AboutMe() {
  return (
    <div className=' lg:h-[100vh] h-[180vh] w-[90vw]' id='about'>
      ...
      <div className="lg:h-[70%] h-[10vh] lg:w-[90vw] w-[97vw] relative lg:top-[10vh] top-[5vh] lg:left-[5vw] left-1  flex lg:flex-row flex-col bg-white lg:shadow-2xl rounded-lg">
      ...
      <p className='lg:text-xl font-bold relative left-[6vw] top-[3vh] w-[30vw] lg:mt-0 mt-[5vh]'>Skills </p>
...
<div className=' w-[100vw] h-[80vh] relative right-[5vw] lg:left-[1vw] lg:top-[3vh] bottom-[10vh] lg:bottom-0 lg:mt-0 mt-[25vh]'>
...
<p className='  relative  lg:top-[13vh] lg:w-[40vw] top-[10vh] lg:left-0  w-[90vw] left-10'>As a computer science graduate with a keen interest in MERN stack development, my journey into web development has been both exciting and challenging. Mastering MongoDB, Express.js, React, and Node.js has empowered me to create dynamic and responsive web applications. The versatility of JavaScript across the stack allows me to build seamless user interfaces and robust backend services, enhancing my ability to craft efficient and modern web solutions. Alongside coding, my passion for web design ensures that user experience remains at the forefront, blending functionality with aesthetics to deliver intuitive and visually compelling interfaces.</p>
<p className='  relative lg:top-[15vh] lg:w-[40vw] top-[12vh]   left-10 w-[90vw] lg:left-0 '>In addition to my expertise in MERN stack development, I have a deep fascination with 3D modeling, which allows me to bring virtual concepts to life. Through tools like Blender and Autodesk Maya, I create intricate and realistic 3D models, leveraging my understanding of shapes, textures, and lighting. This blend of technical proficiency and artistic creativity enables me to visualize and construct virtual environments, from architectural designs to character animations. Integrating my skills in web design further complements my ability to showcase 3D models in interactive and engaging ways, ensuring that every project resonates with both functionality and visual appeal.</p>
